            ...
            <div className='max-w-[1430px] mx-auto py-16 tab:py-0 mob:py-10 flex gap-8 mob:flex-col tab:px-5'>
                <div className='relative overflow-hidden'>
                    <div>
                        ...
                        <div className='absolute flex flex-col gap-4 top-1/2 left-16 transform -translate-y-1/2 tab:left-6 tab:gap-1'>
                            <p className='text-xl font-medium tab:font-normal tab:text-lg'>Up to 45% Discount</p>
                            <h2 className='text-3xl font-black tracking-wider tab:font-bold tab:tracking-tight'>Premium Pick</h2>
                ...
                <div className='relative overflow-hidden'>
                    <div>
                        ...
                        <div className='absolute flex flex-col gap-4 top-1/2 left-16 transform -translate-y-1/2 tab:left-6 tab:gap-1'>
                            <p className='text-xl font-medium tab:font-normal tab:text-lg'>Buy 2 Get 1 FREE</p>
                            <h2 className='text-3xl font-black tracking-wider tab:font-bold tab:tracking-tight'>Limited Offers</h2>
                            <a className='text-base font-semibold tracking-wider underline decoration-2 transform hover:scale-110 duration-300 tab:pt-2' href='#'>Shop Now</a>
                        </div>
                    </div>
                </div>
