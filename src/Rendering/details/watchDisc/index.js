    ...
    return (
        <div>
            <div className='max-w-[1400px] mx-auto mob:mx-3'>
                <div className='flex gap-10 justify-center text-center items-center border-b border-borderGray mb-5 tab:w-[700px] tab:mx-auto tab:overflow-x-auto tab:justify-between mob:w-[330px]'>
                ...
                <div className='tab:px-5'>
                    <div className='text-base text-textGray my-4 tab:text-sm mob:text-xs'>
                    ...
                    <div className='my-4'>
                        <div className='text-2xl font-semibold text-black mb-1 tab:text-xl mob:text-base'>
                            <h3>Amazing Features:</h3>
                        </div>
                        <div className='text-base text-textGray mb-2 mr-2 tab:text-sm mob:text-xs'>
