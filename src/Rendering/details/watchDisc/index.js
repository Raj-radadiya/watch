        ...
        return (
            <div>
                <div className='max-w-[1400px] mx-auto mob:mx-3'>
                    <div className='flex gap-10 justify-center text-center items-center border-b border-borderGray mb-5 tab:w-[700px] tab:mx-auto tab:overflow-x-auto tab:justify-between mob:max-w-[390px] mob:gap-5'>
